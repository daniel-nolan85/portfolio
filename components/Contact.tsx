...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setStatus('sending');
    // Wire up to your email service when ready
  ...
  return (
    <section id="contact" className="section" style={{ position: 'relative' }}>
      <div
        ...
        style={{ width: '400px', height: '400px', bottom: '0', left: '50%', transform: 'translateX(-50%)', opacity: 0.3 }}
      />
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', position: 'relative', zIndex: 2 }}>
        <FadeIn>
          <div style={{ marginBottom: '4rem' }}>
            ...
            >
              Whether you have a project in mind, want to discuss a role, or just want to say hello —
          ...
          <FadeIn direction="right" delay={100}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <div className="glass" style={{ borderRadius: '16px', padding: '1.5rem' }}>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', marginBottom: '0.5rem', letterSpacing: '0.08em' }}>
                  EMAIL
                </p>
                <a
              ...
              <div className="glass" style={{ borderRadius: '16px', padding: '1.5rem' }}>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', marginBottom: '1rem', letterSpacing: '0.08em' }}>
                  FIND ME ON
                </p>
                  ...
                  {[
                    ...
                    <div key={field.id}>
                      ...
                      <input
                        ...
                        onFocus={(e) => (e.currentTarget.style.borderColor = 'var(--cyan-ice)')}
